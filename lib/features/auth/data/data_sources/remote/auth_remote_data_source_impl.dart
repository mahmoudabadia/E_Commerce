...
import 'package:e_commerce_app/features/auth/data/models/response/auth/auth_response_dto.dart';
...
class AuthRemoteDataSourceImpl implements AuthRemoteDataSource {
  ...
  Future<ApiResult<AuthResponseDto>> login(LoginRequestDto loginRequest) async {
    try {
      ...
      return ErrorApiResult(errorMessage: ServerErrors(message: errorMessage));
    } catch (e) {
      return ErrorApiResult(errorMessage: UnknownErrors());
    }
  }
